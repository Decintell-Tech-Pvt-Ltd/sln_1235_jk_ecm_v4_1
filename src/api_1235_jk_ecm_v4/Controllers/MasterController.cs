...
namespace api_1235_jk_ecm_v4.Controllers
{
    ...
    public class MastersController : Controller
    {
        ...
        [HttpPost]
        [Route("CT_GetProcessNameByPL")]
        public async Task<IActionResult> CT_GetProcessNameByPL()
        {

            string spName = "usp_CT_GetProcessNameByPL";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        [HttpPost]
        [Route("InsertValueStream")]
        public async Task<IActionResult> InsertValueStream()
        {

            string spName = "usp_InsertValueStream";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        public async Task<IActionResult> GetLookupMasterData()
        {
            ...
            string spName = "usp_GetLookupMasterData";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        public async Task<IActionResult> GetLookupById()
        {
            ...
            string spName = "usp_GetLookupById";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        public async Task<IActionResult> GetProductList()
        {
            ...
            string spName = "usp_GetProductList";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        public async Task<IActionResult> AddProductLine()
        {
            ...
            string spName = "usp_AddProductLine";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        public async Task<IActionResult> GetProductById()
        {
            ...
            string spName = "usp_GetProductById";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        {
            string spName = "usp_DeleteParameter";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        {
            string spName = "usp_DeleteProcess";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        [HttpPost]
        [Route("GetValuestreamById")]
        public async Task<IActionResult> GetValuestreamById()
        {
            string spName = "usp_GetValuestreamById";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        [HttpGet]
        [Route("GetFileTypeParameters")]
        public async Task<IActionResult> GetFileTypeParameters()
        {
            string spName = "usp_GetFileTypeParameters";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        [HttpGet]
        [Route("GetFileTypeProcess")]
        public async Task<IActionResult> GetFileTypeProcess()
        {
            string spName = "usp_GetFileTypeProcess";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        [HttpPost]
        [Route("FileParameterAdd")]
        public async Task<IActionResult> FileParameterAdd()
        {
            string spName = "usp_InsertFileTypeParameter";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        [HttpPost]
        [Route("FileProcessAdd")]
        public async Task<IActionResult> FileProcessAdd()
        {
            string spName = "usp_InsertFileTypeProcess";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        [HttpPost]
        [Route("DeleteFileProcess")]
        public async Task<IActionResult> DeleteFileProcess()
        {
            string spName = "usp_DeleteFileProcess";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
        ...
        [HttpPost]
        [Route("DeleteFileParameter")]
        public async Task<IActionResult> DeleteFileParameter()
        {
            string spName = "usp_DeleteFileParameter";
            string strJsonRequest = await new StreamReader(Request.Body).ReadToEndAsync();
            string jsonResult;
            if (string.IsNullOrEmpty(strJsonRequest))
            {
